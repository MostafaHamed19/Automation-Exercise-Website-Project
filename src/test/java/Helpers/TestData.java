...
public class TestData {
    ...
    public static final int BIRTH_YEAR = 2002;

    public static final String FIRST_NAME = "John";
    public static final String LAST_NAME = "Doe";
    public static final String COMPANY = "ITI";
    public static final String FIRST_ADDRESS = "Smart Village";
    public static final String SECOND_ADDRESS = "Fifth Street";
    public static final String COUNTRY = "Canada";
    public static final String STATE = "UK";
